...
const defaultAffairs: Array<AffairType> = [ // need to fix any
    ...
    {_id: 2, name: 'Cars', priority: 'low'},
    {_id: 3, name: 'Games', priority: 'low'},
    {_id: 4, name: 'Family', priority: 'high'},
...
//     // return affairs.map(affair => affair.priority === filter ? {priority:filter} ) // need to fix
// }
...
//         // setAffairs(affairs.map(affairs))
